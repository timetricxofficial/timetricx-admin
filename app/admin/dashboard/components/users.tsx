  ...
  return (
    <>
      ...
      <div className="relative w-[260px] h-[200px] overflow-visible">
        ...
        {/* Base Card */}
        <div className={`${isDark ? 'bg-indigo-900/30' : 'bg-indigo-100'} rounded-2xl p-5 shadow-sm h-full`}>
        ...
        >
          ...
          <div className="flex justify-between items-start">
            <div className={`w-10 h-10 ${isDark ? 'bg-indigo-900/50' : 'bg-indigo-100'} rounded-xl flex items-center justify-center ${isDark ? 'text-indigo-400' : 'text-indigo-600'}`}>
              <Users size={20} />
            </div>
          </div>
