...
export default function Admin() {
  ...
  const filtered = admins.filter(a => {
    // Hide current logged-in admin from the list
    if (currentAdmin && a.email === currentAdmin.email) return false
              ...
              >
                ...
                <td className="p-3 flex justify-center gap-3">
                  ...
                  <button
                    ...
                    disabled={!canView()}
                    className={`text-green-600 ${canView() ? 'hover:scale-110 cursor-pointer' : 'cursor-not-allowed opacity-30'
                      }`}
                  >
                    <Eye size={18} />
                  </button>
