...
export default function AddAnnouncement({ onClose }: AddAnnouncementProps) {
  ...
  const [form, setForm] = useState({
    ...
    startAt: '',
    endAt: '',
    targetAudienceType: 'all' as 'all' | 'selected' | 'workingRole',
    targetAudienceData: [] as string[]
  })
      ...
      >
        ...
        <div style={{ marginTop: 25 }}>
          ...
          <div style={{ marginTop: 25, display: 'flex', gap: 10 }}>
            ...
            <Btn primary onClick={createAnnouncement} disabled={isSubmitting}>
