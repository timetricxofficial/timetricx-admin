        ...
        <table className="w-full text-sm">
          ...
          <thead className={`border-b transition-colors text-left ${theme === 'dark'
            ...
            <tr>
              ...
              <th className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Username</th>
              <th className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Email</th>
              <th className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>From</th>
              <th className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>To</th>
              <th className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Days</th>
              <th className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Status</th>
          ...
          <tbody>
            {leaves.map((leave, index) => (
              ...
              >
                ...
                <td className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>{leave.userName}</td>
                <td className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>{leave.userEmail}</td>
                <td className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                ...
                <td className={`p-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>{leave.totalDays}</td>
