...
import { LayoutDashboard, Users, Folder, Settings, Calendar, Camera, Video, Megaphone, FileText, ShieldAlert } from "lucide-react"
...
const menu = [
  ...
  { name: "contact", icon: ShieldAlert, path: "/admin/contact" },
